...
c---------------------------------------------------------------------
c  Floating point arrays here are named as in NPB1 spec discussion of
c  CG algorithm
c---------------------------------------------------------------------
...
c  (This is equivalent to allreduce operation.)
...
c---------------------------------------------------------------------
      ...
      implicit none
!      interface ! needed because conj_grad is called before conj_grad has co-array dummy arguments
...
CC      >           rcond=1.0d-1 )
     ...
     >                         iv(2*na+1), arow(nz), acol(nz)
      ...
      double precision, save:: v(na+1)[0:*],
     >                         aelt(nz)[0:*],
     >                         a(nz)[0:*],
...
c---------------------------------------------------------------------
c  Set up initialization and number of proc testing
c---------------------------------------------------------------------
...
c---------------------------------------------------------------------
c---------------------------------------------------------------------
      subroutine initialize_image_info
c---------------------------------------------------------------------
c---------------------------------------------------------------------
      use cg_global_coarrays
...
c---------------------------------------------------------------------
c      nonzero is approximately  (int(sqrt(nnza /n)));
c---------------------------------------------------------------------
