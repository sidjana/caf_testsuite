...
c      >                         r,
c      >                         w
c       double precision         v(na+1), aelt(nz), a(nz),
c      >                         x(na/num_proc_rows+2),
c      >                         z(na/num_proc_rows+2),
c      >                         p(na/num_proc_rows+2),
c      >                         q(na/num_proc_rows+2),
c      >                         r(na/num_proc_rows+2),
c      >                         w(na/num_proc_rows+2)
