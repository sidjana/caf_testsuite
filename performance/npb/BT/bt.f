...
c---------------------------------------------------------------------
 ...
 200            format(' Time step ', i4)
       ...
       t1(1) = t
       call mco_maxval_r8(t1, tmaxg, 1, team)
       tmax = tmaxg(1)
       ...
       if (iotype .ne. 0) then
          ...
          t1(1) = t
          call mco_sum_r8(t1, tming, 1, team)
          tiominv = tming(1)
       endif
 ...
 1100        format(/' BTIO -- statistics:'/
     ...
     >     cs6, '(none)')
       ...
       call mco_sum_r8(t1, tsum, t_last+2, team)
       call mco_minval_r8(t1, tming, t_last+2, team)
       call mco_maxval_r8(t1, tmaxg, t_last+2, team)
