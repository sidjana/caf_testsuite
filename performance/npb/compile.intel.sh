...
make clean
make EP NPROCS=1 CLASS=B
make clean
make EP NPROCS=1 CLASS=C
make clean
...
make clean
make EP NPROCS=2 CLASS=B
make clean
make EP NPROCS=2 CLASS=C
make clean
...
make clean
make EP NPROCS=4 CLASS=B
make clean
make EP NPROCS=4 CLASS=C
make clean
...
make clean
make SP NPROCS=1 CLASS=A
make clean
make SP NPROCS=1 CLASS=B
make clean
make SP NPROCS=1 CLASS=C
...
make clean
make SP NPROCS=4 CLASS=B
make clean
make SP NPROCS=4 CLASS=C
...
make clean
make SP NPROCS=9 CLASS=A
make clean
make SP NPROCS=9 CLASS=B
make clean
make SP NPROCS=9 CLASS=C
...
make clean
make SP NPROCS=16 CLASS=A
make clean
make SP NPROCS=16 CLASS=B
make clean
make SP NPROCS=16 CLASS=C
...
make clean
make BT NPROCS=1 CLASS=B
make clean
make BT NPROCS=1 CLASS=C
...
make clean
make BT NPROCS=4 CLASS=B
make clean
make BT NPROCS=4 CLASS=C
...
make clean
make BT NPROCS=9 CLASS=A
make clean
make BT NPROCS=9 CLASS=B
make clean
make BT NPROCS=9 CLASS=C
...
#
#sed 's/-coarray-num-images=16 /-coarray-num-images=32 /g' ./config/make.def > ./config/make.def.intel
#cp ./config/make.def.intel ./config/make.def
#make clean
#make CG NPROCS=32 CLASS=S
#
#sed 's/-coarray-num-images=32 /-coarray-num-images=1 /g' ./config/make.def > ./config/make.def.intel
#cp ./config/make.def.intel ./config/make.def
